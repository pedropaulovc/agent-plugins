...
approval, rerun the script with the original arguments plus `--confirm`. In `--force`
mode, do not ask for worktree or stash confirmation: the script discards tracked,
untracked, ignored, and repository-wide stashed changes.
