...
**OpenCode:** mutates the Bash arguments in `tool.execute.before` without changing the normal permission flow, then appends the advisory context to the tool result.
