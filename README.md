...
| [watch-pr](plugins/watch-pr) | MCP Server + Skill | `/watch-pr` — subscribes to durable GitHub PR lifecycle updates from the hosted OAuth-authenticated MCP server and acts on CI, rebases, reviews, feedback, and merge or closure |
